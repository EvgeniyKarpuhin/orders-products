          ...
          <div role="button" v-for="order in ordersWithProducts" :key="order.id"
            ...
            <div class="flex-grow-1 d-flex justify-content-between align-items-center m-3">
              ...
              <div class="text-start d-flex align-items-center">
                <div>
                  <i class="bi bi-list-ul me-3 text-secondary"
                    style="font-size: x-large;border: 1px solid;border-radius: 50%;width: 40px;display: flex;height: 40px;justify-content: center;align-items: center;"></i>
                </div>
                <div>
            ...
            <div v-if="selectedOrder?.id === order.id"
          ...
          <div v-if="selectedOrder" key="details" class="card mh-80" style="max-height: 80vh;">
            <div class="overflow-x-hidden">
              ...
              <ul class="list-group rounded-0">
                <li v-for="p in selectedOrder.products" :key="p.id"
                  class="d-flex align-items-center gap-3 border-top border-bottom btnHov p-4">
...
.order-details .placeholder-block {
  background: #f8f9fb;
  border-radius: 8px;
  padding: 40px;
}
